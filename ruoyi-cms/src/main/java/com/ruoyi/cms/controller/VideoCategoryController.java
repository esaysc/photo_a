...
import com.ruoyi.cms.domain.VideoCategory;
import com.ruoyi.cms.service.IVideoCategoryService;
 ...
 */
@RestController
@RequestMapping("/cms/video_category")
public class VideoCategoryController extends BaseController
{
     ...
     * 查询视频分类列表
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:list')")
    @GetMapping("/list")
     ...
     * 导出视频分类列表
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:export')")
     ...
     * 获取视频分类详细信息
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增视频分类
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:add')")
     ...
     * 修改视频分类
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:edit')")
     ...
     * 删除视频分类
     */
    @PreAuthorize("@ss.hasPermi('cms:video_category:remove')")
