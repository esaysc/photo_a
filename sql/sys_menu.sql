...
) ENGINE = InnoDB AUTO_INCREMENT = 2079 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_bin COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (4, '若依官网', 0, 4, 'http://ruoyi.vip', NULL, '', '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2025-05-17 15:01:03', '', NULL, '若依官网地址');
...
INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', '', 1, 0, 'C', '0', '0', 'system:dept:list', 'tree', 'admin', '2025-05-17 15:01:03', '', NULL, '部门管理菜单');
INSERT INTO `sys_menu` VALUES (104, '岗位管理', 1, 5, 'post', 'system/post/index', '', '', 1, 0, 'C', '0', '0', 'system:post:list', 'post', 'admin', '2025-05-17 15:01:03', '', NULL, '岗位管理菜单');
...
INSERT INTO `sys_menu` VALUES (2042, '小波变化法', 2041, 1, 'wavelet-transform-method', NULL, NULL, '', 1, 0, 'M', '0', '0', '', 'tree', 'admin', '2025-05-21 20:10:14', 'admin', '2025-05-21 20:10:23', '');
INSERT INTO `sys_menu` VALUES (2043, '金字塔法', 2041, 2, 'jinzita-method', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 20:18:42', '', NULL, '');
...
INSERT INTO `sys_menu` VALUES (2045, '稀疏法', 2044, 1, 'sparse-method', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 20:20:45', '', NULL, '');
...
INSERT INTO `sys_menu` VALUES (2047, '卷积神经网络', 2046, 1, 'convolutional-neural-network', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 22:00:36', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2048, '生成对抗网络', 2046, 2, 'generating-countermeasure-network', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 22:04:44', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2049, '自编码器', 2046, 3, 'self-encoder', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 22:05:28', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2050, '改进方法', 2039, 3, 'improve-method', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 22:06:17', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2051, 'GANResNet', 2050, 1, 'ganresnet', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'tree', 'admin', '2025-05-21 22:07:33', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2052, '学习资源', 0, 11, 'study-re', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'list', 'ry', '2025-05-22 11:13:18', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2067, '图书', 2052, 1, 'book', 'cms/book/index', NULL, '', 1, 0, 'C', '0', '0', 'cms:book:list', '#', 'admin', '2025-05-22 12:35:22', '', NULL, '图书菜单');
...
INSERT INTO `sys_menu` VALUES (2073, '视频', 2052, 1, 'video', 'cms/video/index', NULL, '', 1, 0, 'C', '0', '0', 'cms:video:list', '#', 'admin', '2025-05-22 12:35:31', '', NULL, '视频菜单');
